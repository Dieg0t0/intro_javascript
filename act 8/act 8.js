...
this.name = "mario";
this.age = 26;
this.hobbies = ["Running", "videogames", "TKO"];
},
};
...
for (let index = 0; index < array.length; index++) {
    let suma = array[index].a + array[index].b;
    console.log(suma + " " + array[index].name);
}
};

sumProperties(simpleExercise);
